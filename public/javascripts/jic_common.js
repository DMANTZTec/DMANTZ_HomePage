...
function RegistrationForm() {
    var element = document.getElementById("RegistrationModal");
    element.style.display = "block";
    var element1 = document.getElementById("loginModal");
...
function loginform() {
    var ele = document.getElementById('loginModal');
...
window.onclick = function(event) {
    //if (event.target == document.getElementById("Contact_Section1")) {
    //  document.getElementById("Contact_Section1").style.display = "none";
    // }
    switch(event.target) {
        case document.getElementById("ContactUsModal"):
            document.getElementById("ContactUsModal").style.display = "none";
            break;
        case document.getElementById("RegistrationModal"):
